...
public class RenderMultiToolAssist {
  ...
  public static void onMouseEvent(InputEvent.MouseScrollingEvent event) {
    ...
    if (event.getScrollDeltaY() != 0 && player != null && player.isShiftKeyDown()) {
      ...
      if (player.isShiftKeyDown() && !stack.isEmpty() && stack.getItem() instanceof ItemMultiTool) {
        changeHelpMode((int) Math.round(event.getScrollDeltaY()));
  ...
  //    if (resultPick.getType() == RayTraceResult.Type.MISS || !(resultPick instanceof
  // BlockRayTraceResult)) {
  //      return;
  //    }
  //
  ...
  //      state = state.getStateAtViewpoint(player.getCommandSenderWorld(), result.getBlockPos(),
  ...
  //  }
  //
  //  private static void renderRemovePreview(RenderWorldLastEvent event, BlockRayTraceResult
  // result) {
  ...
  //  }
  //
  //  private static void renderBlockPreview(RenderWorldLastEvent event, BlockRayTraceResult result,
  ...
  //                                       BlockPos toRenderAt, @Nonnull IBakedModel model, @Nonnull
  // BlockState state) {
  ...
  //    event.getMatrixStack().translate(toRenderAt.getX() - x, toRenderAt.getY() - y,
  // toRenderAt.getZ() - z);
  //    IVertexBuilder buffer =
  // Minecraft.getInstance().renderBuffers().bufferSource().getBuffer(GhostRenderType.getInstance());
  ...
  //
  //    public GhostRenderType(String p_i225992_1_, VertexFormat p_i225992_2_, int p_i225992_3_, int
  // p_i225992_4_, boolean p_i225992_5_, boolean p_i225992_6_, Runnable p_i225992_7_, Runnable
  // p_i225992_8_) {
  //      super(p_i225992_1_, p_i225992_2_, p_i225992_3_, p_i225992_4_, p_i225992_5_, p_i225992_6_,
  // p_i225992_7_, p_i225992_8_);
  //    }
  //
