...
public class RenderMultiBoots extends AbstractRenderMultiArmor {
  ...
  public RenderMultiBoots() {
    ...
    //        ModelRenderOBJ rightBoot = new ModelRenderOBJ(this, new ResourceLocation(MODID,
    // "item/armor/multi_right_boot.obj"));
    //        ModelRenderOBJ leftBoot = new ModelRenderOBJ(this, new ResourceLocation(MODID,
    // "item/armor/multi_left_boot.obj"));
    //
