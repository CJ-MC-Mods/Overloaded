...
public class RenderMultiChestplate extends AbstractRenderMultiArmor {
  ...
  public RenderMultiChestplate() {
    ...
    //
    //        ModelRenderOBJ body = new ModelRenderOBJ(this, new ResourceLocation(MODID,
    // "item/armor/multi_body.obj"));
    //        ModelRenderOBJ rightArm = new ModelRenderOBJ(this, new ResourceLocation(MODID,
    // "item/armor/multi_right_arm.obj"));
    //        ModelRenderOBJ leftArm = new ModelRenderOBJ(this, new ResourceLocation(MODID,
    // "item/armor/multi_left_arm.obj"));
    //
    //        body.offsetY = 0.755F;
