...
public class PlayerInterfaceRenderer implements BlockEntityRenderer<TilePlayerInterface> {
  ...
  @Override
  public void render(@Nonnull TilePlayerInterface te, float v, @Nonnull PoseStack matrixStack, @Nonnull MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
