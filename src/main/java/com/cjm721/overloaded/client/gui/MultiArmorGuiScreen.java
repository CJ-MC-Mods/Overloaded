...
public class MultiArmorGuiScreen extends GuiScreen {
    ...
    public void initGui() {
        ...
        int id = 0;
        this.save = addButton(new GuiButton(id++, this.width / 2, this.height / 4 + 100, 150, 20, "Save"));
        ...
        this.feedEnabled = addButton(new GuiToggle(id++, this.width / 2, this.height / 4 + 20, booleans.getOrDefault(DataKeys.FEED, Default.FEED), "Feeder:"));
        this.healEnabled = addButton(new GuiToggle(id++, this.width / 2 - 150, this.height / 4 + 40, booleans.getOrDefault(DataKeys.HEAL, Default.HEAL), "Healer:"));
        this.removeHarmfulEnabled = addButton(new GuiToggle(id++, this.width / 2, this.height / 4 + 40, booleans.getOrDefault(DataKeys.REMOVE_HARMFUL, Default.REMOVE_HARMFUL), "Remove Harmful Potions:"));
        this.giveAirEnabled = addButton(new GuiToggle(id++, this.width / 2 - 150, this.height / 4 + 60, booleans.getOrDefault(DataKeys.GIVE_AIR, Default.GIVE_AIR), "Airer:"));
        this.extinguishEnabled = addButton(new GuiToggle(id++, this.width / 2, this.height / 4 + 60, booleans.getOrDefault(DataKeys.EXTINGUISH, Default.EXTINGUISH), "Extinguisher:"));
        this.noClipFlightLock = addButton(new GuiToggle(id++, this.width / 2 - 75, this.height / 4 + 80, booleans.getOrDefault(DataKeys.NOCLIP_FLIGHT_LOCK, Default.NOCLIP_FLIGHT_LOCK), "No Clip Flight Lock:"));
    }
